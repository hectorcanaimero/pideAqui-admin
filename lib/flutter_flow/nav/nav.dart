...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/productosPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'ProductosPage')
        ...
        FFRoute(
          ...
          path: '/pedidosPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'PedidosPage')
              : const PedidosPageWidget(),
        ),
        FFRoute(
          name: 'UserPage',
          path: '/userPage',
        ...
        FFRoute(
          ...
          path: '/customerPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'CustomerPage')
              : const CustomerPageWidget(),
        ),
        FFRoute(
          name: 'SettingPage',
          path: '/settingPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => const CreateProductPageWidget(),
        ),
        FFRoute(
          name: 'DetailOrderPage',
          path: '/detailOrderPage',
          builder: (context, params) => DetailOrderPageWidget(
            uid: params.getParam(
              'uid',
              ParamType.DocumentReference,
              false,
        ...
        FFRoute(
          name: 'DetailCustomerPage',
          path: '/detailCustomerPage',
          builder: (context, params) => DetailCustomerPageWidget(
            uid: params.getParam(
              'uid',
              ParamType.DocumentReference,
              false,
        ...
        FFRoute(
          name: 'ComanderPage',
          path: '/comanderPage',
          builder: (context, params) => const ComanderPageWidget(),
        ),
        FFRoute(
          name: 'ReportsPage',
          path: '/reportsPage',
