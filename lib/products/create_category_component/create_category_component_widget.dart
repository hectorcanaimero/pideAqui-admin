...
class CreateCategoryComponentWidget extends StatefulWidget {
  ...
  State<CreateCategoryComponentWidget> createState() =>
      _CreateCategoryComponentWidgetState();
}

class _CreateCategoryComponentWidgetState
    extends State<CreateCategoryComponentWidget> {
  late CreateCategoryComponentModel _model;
  ...
  void initState() {
    ...
    _model.orderFieldTextController ??= TextEditingController();
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 12.0),
                            child: TextFormField(
                              controller: _model.orderFieldTextController,
