...
class _CreateUserPageWidgetState extends State<CreateUserPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.responsePlan = await queryPlansRecordOnce(
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://firebasestorage.googleapis.com/v0/b/sport-trivia-hgcdqn.appspot.com/o/admin%2Flogo.png?alt=media',
                                      height: 40.0,
                                      fit: BoxFit.fitWidth,
                                    ),
                                  ),
                                        ...
                                        onPressed: () async {
                                          ...
                                          await UsersRecord.collection
                                              ...
                                              .update(createUsersRecordData(
                                                ...
                                                planAt: getCurrentTimestamp,
                                                plan: _model
                                                    .responsePlan?.reference,
                                              ));
