                      ...
                      children: [
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.network(
                                'https://solutions.trustradius.com/wp-content/uploads/construction-software-scaled-1200x800.jpg',
                                width: double.infinity,
                                height: 200.0,
                                fit: BoxFit.cover,
                              ),
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 20.0, 0.0),
                          child: Text(
                            'En Breve te traemos una serie de reportes para ayudarte en la toma de decisiones.',
