...
class EditCompanyPageWidget extends StatefulWidget {
  ...
  @override
  State<EditCompanyPageWidget> createState() => _EditCompanyPageWidgetState();
}
...
class _EditCompanyPageWidgetState extends State<EditCompanyPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CompaniesRecord>(
      stream: CompaniesRecord.getDocument(widget.uid!),
      builder: (context, snapshot) {
        ...
        final editCompanyPageCompaniesRecord = snapshot.data!;
                            ...
                            children: [
                              Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.nameFieldTextController ??=
                                    ...
                                    text: editCompanyPageCompaniesRecord.name,
                                  ),
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    ...
                                    () async {
                                      setState(() {
                                        _model.slug = functions.getSlug(_model
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'Nombre de la Compañia',
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Align(
                                      alignment: const AlignmentDirectional(1.0, 0.0),
                                      child: Text(
                                        editCompanyPageCompaniesRecord.slug,
                              ...
                              Padding(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  controller:
                                      _model.countryDownValueController ??=
                                          FormFieldController<String>(
                                    _model.countryDownValue ??=
                                        editCompanyPageCompaniesRecord.country,
                                  ),
                                  options: const [
                                    'Venezuela',
                              ...
                              Builder(
                                builder: (context) {
                                  if (_model.countryDownValue == 'Venezuela') {
                                    return Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 16.0),
                                      child: TextFormField(
                                        controller:
                                            _model.venFieldTextController ??=
                                                TextEditingController(
                                          text: editCompanyPageCompaniesRecord
                                              .phone,
                                        ),
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.emailFieldTextController ??=
                                          TextEditingController(
                                    text: editCompanyPageCompaniesRecord.email,
                                  ),
                              ...
                              Padding(
                                ...
                                child: FlutterFlowCheckboxGroup(
                                  options: const ['Delivery', 'Retirar en tienda'],
                                  onChanged: (val) => setState(
                                      () => _model.checkboxGroupValues = val),
                                  controller:
                                      _model.checkboxGroupValueController ??=
                                          FormFieldController<List<String>>(
                                    editCompanyPageCompaniesRecord
                                        .operationMode,
                                  ),
                                  activeColor:
                                      FlutterFlowTheme.of(context).primary,
                              ...
                              Align(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await widget.uid!.update({
                                      ...createCompaniesRecordData(
                                        name:
                                            _model.nameFieldTextController.text,
                                        phone: _model.countryDownValue ==
                                                'Venezuela'
